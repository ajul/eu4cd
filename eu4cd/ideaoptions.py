...
floatValues = (
    0.001, 0.0015, 0.002, 0.0025, 0.003, 0.004, 0.005,
    0.01, 0.015, 0.02, 0.025, 0.03, 0.04, 0.05, 0.06, 0.075,
    0.1, 0.15, 0.2, 0.25, 0.3, 0.33, 0.4, 0.5, 0.6, 0.66, 0.75,
...
bonusData = (
    ...
    ("colonists",                   1, (1, 1)),
    # ("colonist_time",               -1/3, (-0.1, -0.33)), # Expansion only, omitted due to Colonial Enthusiasm interaction
    ...
    ("global_manpower_modifier",    0.2, (0.05, 1.0)), # 0.2 to 0.5?
    ("global_missionary_strength",  0.02, (0.01, 0.05)),
    ("global_own_trade_power",      0.2, (0.05, 0.25)), 
    ("global_prov_trade_power_modifier", 0.2, (0.05, 0.25)),
    ("global_regiment_cost",        -0.1, (-0.05, -0.1)),
    ...
    ("imperial_authority",          0.1, (0.05, 0.25)),
    ("infantry_cost",               -0.2, (-0.1, -0.33)), #OP?
    ("infantry_power",              0.1, (0.05, 0.2)),
